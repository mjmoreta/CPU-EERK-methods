function [wout, m, stats] = phipm_simul_iom9points(t, J, u, tol, m, iom)
% This program is based on program phipm_simul_iom:
% Luan, V. T., Pudykiewicz, J. A. and Reynolds, D. R., Further development 
% of efficient and accurate time integration schemes for meteorological models, 
% J. Comput. Phys. 376, 817-837 (2019)

% Usage: [wout, m, stats] = phipm_simul_iom(t, A, u, tol, m, iom)
%
